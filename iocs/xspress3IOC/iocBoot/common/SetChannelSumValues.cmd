...
dbpf("$(PREFIX)ROI$(CHAN):SizeY", "8")
dbpf("$(PREFIX)ROI$(CHAN):BinY", "8")

dbpf("$(PREFIX)ROISUM$(CHAN):EnableX", "Enable")
dbpf("$(PREFIX)ROISUM$(CHAN):EnableY", "Enable")
dbpf("$(PREFIX)ROISUM$(CHAN):EnableZ", "Disable")
dbpf("$(PREFIX)ROISUM$(CHAN):SizeY", "8")
dbpf("$(PREFIX)ROISUM$(CHAN):BinY", "8")

dbpf("$(PREFIX)MASK:EnableCallbacks", "Enable")
dbpf("$(PREFIX)MASKSUM:EnableCallbacks", "Enable")
